...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { email: @employer.email, fname: @employer.fname, lname: @employer.lname, password_digest: @employer.password_digest, phone: @employer.phone, worker_id: @employer.worker_id }
    end
  ...
  test "should update employer" do
    put :update, id: @employer, employer: { email: @employer.email, fname: @employer.fname, lname: @employer.lname, password_digest: @employer.password_digest, phone: @employer.phone, worker_id: @employer.worker_id }
    assert_redirected_to employer_path(assigns(:employer))
  end
